             ...
             <div className="flex flex-col h-full">
                ...
                <CardContent className="flex-1 flex flex-col p-4">
                    <div className="flex flex-col gap-2 mb-4">
                        <h3 className="font-semibold text-lg mb-2 line-clamp-1">{anime.title.romaji}</h3>
                        <h4 className="text-sm font-semibold">Score: { anime.averageScore ? anime.averageScore / 10 : "N/A"}</h4>
                    </div>
                    <div className="mt-auto">
                        ...
                        <div className="bg-zinc-100 dark:bg-zinc-900 rounded-lg p-3 mt-4">
                            <div className="flex items-center gap-1 text-zinc-700 dark:text-zinc-300 text-xs mb-1">
                                ...
                                <span>Countdown to Episode {anime.nextAiringEpisode?.episode ? anime.nextAiringEpisode.episode : 1}</span>
                            </div>
